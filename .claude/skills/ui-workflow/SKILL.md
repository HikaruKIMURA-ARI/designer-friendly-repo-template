...
1. atmos 単位の UI を `shared/ui` に実装すること
2. `Molecules` `Organism`, `Templates` 単位の UI を `features/<feature-name>/ui` に実装すること
3. `Page` 単位の UI は `features/<feature-name>/ui/<feature-name>Page.tsx` に実装すること
